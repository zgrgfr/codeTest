...
public class MailUtil {
    public static void main(String[] args) {
        MailUtil.sendMailForTest(ConfigInfo.mail_host,ConfigInfo.mail_port,ConfigInfo.mail_username,
                ConfigInfo.mail_password,ConfigInfo.mail_from,"guofengrui@jd.com");
    }
    ...
    public static void sendFileMail(String to,String subject,String html,String contentId,Resource resource) throws  Exception{
        MimeMessage mimeMessage = mailSender.createMimeMessage();
        // 设置utf-8或GBK编码，否则邮件会有乱码
        MimeMessageHelper messageHelper = new MimeMessageHelper(mimeMessage, true, "UTF-8");
        messageHelper.setFrom(mailFrom);
